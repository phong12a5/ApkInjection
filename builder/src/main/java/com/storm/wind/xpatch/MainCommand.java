...
public class MainCommand extends BaseCommand {
    ...
    @Opt(opt = "c", longOpt = "crack", hasArg = false,
            description = "disable cracking the apk's signature.")
    ...
    /*
    @Opt(opt = "hap", longOpt = "hookApkPath", hasArg = false, description = "Hook the apk installed path, " +
